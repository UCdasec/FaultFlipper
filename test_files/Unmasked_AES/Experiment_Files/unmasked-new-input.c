...
static void phex(uint8_t* str)
{
  ...
  // CBC/CTR always in/out of 64
  // ECB always in/out of 16
...
/* 
    for all of these test functions, the in[] array gets modified by the
    respective AES encrypt/decrypt functions, which can then be compared
    to what is in out[] to confirm if it's the correct output.
*/


#if (CBC == 1 && defined(ENCRYPT))
static int test_encrypt_cbc(void)
{
    ...
    uint8_t out[] = { 0xbd, 0x84, 0xc9, 0x01, 0xef, 0x63, 0x10, 0x4f, 0xf0, 0x99, 0x8c, 0x68, 0x83, 0x64, 0x22, 0x9b,
                      0xef, 0x83, 0x2f, 0xac, 0x0c, 0x0a, 0x28, 0xad, 0xc2, 0xc2, 0x43, 0xa6, 0x70, 0x5f, 0x78, 0x6f,
                      0x48, 0x15, 0xe2, 0xb6, 0x87, 0xa9, 0x27, 0x19, 0x8c, 0x96, 0xf8, 0x6b, 0x65, 0xbb, 0x1a, 0x48,
                      0x17, 0xb4, 0x24, 0x02, 0x97, 0x10, 0x34, 0x69, 0xc2, 0x48, 0x65, 0x8f, 0xf3, 0x22, 0x41, 0xf9 };
#endif
    ...
    uint8_t in[]  = { 0xaf, 0xcc, 0x83, 0x21, 0x3c, 0x92, 0xa4, 0xa8, 0x57, 0x75, 0x6c, 0x1a, 0x95, 0x1f, 0x20, 0x35,
                      0xa6, 0x99, 0x94, 0x64, 0xb4, 0x56, 0x2d, 0x9a, 0xa2, 0xda, 0xfe, 0xa4, 0x8e, 0x2c, 0x15, 0x37,
                      0x9a, 0x20, 0x77, 0xce, 0x9b, 0x6b, 0xd6, 0x20, 0x3b, 0xe4, 0x4f, 0xed, 0x20, 0xc1, 0xa3, 0xc5,
                      0xd1, 0xc4, 0xb2, 0x6b, 0x67, 0xa7, 0x5c, 0x08, 0x38, 0x0a, 0xf2, 0x44, 0x53, 0x4b, 0xf7, 0xf6};
    struct AES_ctx ctx;
...
static int test_decrypt_cbc(void)
{
    ...
    uint8_t in[] = {  0x76, 0x49, 0xab, 0xac, 0x81, 0x19, 0xb2, 0x46, 0xce, 0xe9, 0x8e, 0x9b, 0x12, 0xe9, 0x19, 0x7d,
                      ...
                      0x73, 0xbe, 0xd6, 0xb8, 0xe3, 0xc1, 0x74, 0x3b, 0x71, 0x16, 0xe6, 0x9e, 0x22, 0x22, 0x95, 0x16,
                      0x3f, 0xf1, 0xca, 0xa1, 0x68, 0x1f, 0xac, 0x09, 0x12, 0x0e, 0xca, 0x30, 0x75, 0x86, 0xe1, 0xa7 };*/
    uint8_t in[] = {  0xbd, 0x84, 0xc9, 0x01, 0xef, 0x63, 0x10, 0x4f, 0xf0, 0x99, 0x8c, 0x68, 0x83, 0x64, 0x22, 0x9b,
                      0xef, 0x83, 0x2f, 0xac, 0x0c, 0x0a, 0x28, 0xad, 0xc2, 0xc2, 0x43, 0xa6, 0x70, 0x5f, 0x78, 0x6f,
                      0x48, 0x15, 0xe2, 0xb6, 0x87, 0xa9, 0x27, 0x19, 0x8c, 0x96, 0xf8, 0x6b, 0x65, 0xbb, 0x1a, 0x48,
                      0x17, 0xb4, 0x24, 0x02, 0x97, 0x10, 0x34, 0x69, 0xc2, 0x48, 0x65, 0x8f, 0xf3, 0x22, 0x41, 0xf9 };
#endif
    ...
    uint8_t out[] = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a,
                      ...
                      0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef,
                      0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 };*/
    uint8_t out[] = { 0xaf, 0xcc, 0x83, 0x21, 0x3c, 0x92, 0xa4, 0xa8, 0x57, 0x75, 0x6c, 0x1a, 0x95, 0x1f, 0x20, 0x35,
                      0xa6, 0x99, 0x94, 0x64, 0xb4, 0x56, 0x2d, 0x9a, 0xa2, 0xda, 0xfe, 0xa4, 0x8e, 0x2c, 0x15, 0x37,
                      0x9a, 0x20, 0x77, 0xce, 0x9b, 0x6b, 0xd6, 0x20, 0x3b, 0xe4, 0x4f, 0xed, 0x20, 0xc1, 0xa3, 0xc5,
                      0xd1, 0xc4, 0xb2, 0x6b, 0x67, 0xa7, 0x5c, 0x08, 0x38, 0x0a, 0xf2, 0x44, 0x53, 0x4b, 0xf7, 0xf6};
//  uint8_t buffer[64];
...
#elif (CBC == 1 && defined(DECRYPT))
    exit = test_decrypt_cbc();    
#elif (ECB == 1 && defined(ENCRYPT))
    exit = test_encrypt_ecb();
#elif (ECB == 1 && defined(DECRYPT))
    exit = test_decrypt_ecb();
#elif (CTR == 1 && defined(ENCRYPT))
    exit = test_encrypt_ctr();
#elif (CTR == 1 && defined(DECRYPT))
